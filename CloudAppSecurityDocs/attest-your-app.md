...
Whether your app is already listed in the Cloud App Catalog, or it's new, submit a [Publisher Attestation](https://docs.microsoft.com/microsoft-365-app-certification/docs/attestation). For help with the Publisher Attestation process, contact appcert@microsoft.com.
